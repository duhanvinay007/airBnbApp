...
import com.duhanvinay.projects.airBnbApp.entity.*;
...
import com.duhanvinay.projects.airBnbApp.repository.*;
import com.duhanvinay.projects.airBnbApp.strategy.PricingService;
...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingDto initialiseBooking(BookingRequest bookingRequest) {
        ...
        Hotel hotel = hotelRepository.findById(bookingRequest.getHotelId()).orElseThrow(() ->  new ResourceNotFoundException("Hotel not found with id :"+
                bookingRequest.getHotelId()));
        Room room = roomRepository.findById(bookingRequest.getRoomId()).orElseThrow(() -> new ResourceNotFoundException("room not found with id : "+
    ...
    public BookingDto addGuests(Long bookingId, List<GuestDto> guestDtoList) {
        ...
        Booking booking = bookingRepository.findById(bookingId).orElseThrow(() ->  new ResourceNotFoundException("Hotel not found with id :"+
                bookingId));

        User user = getCurrentUser();
        if(!user.equals(booking.getUser())){
            throw new UnAuthorisedException("Booking does not belong to this User" + user.getId());
